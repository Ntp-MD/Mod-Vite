      ...
      <div class="filter-section">
        ...
        <div class="filter-group">
          ...
          <div class="filter-options">
            <button
              :class="{ active: isRangeActive(null, null) }"
              @click="clearFilter"
            >
              All
            </button>
            <button
              :class="{ active: isRangeActive(1, 199) }"
              @click="filterRange(1, 199)"
            >
              1–199
            </button>
            <button
              :class="{ active: isRangeActive(200, 399) }"
              @click="filterRange(200, 399)"
            >
              200–399
            </button>
            <button
              :class="{ active: isRangeActive(400, 599) }"
              @click="filterRange(400, 599)"
            >
              400–599
            </button>
            <button
              :class="{ active: isRangeActive(600, 800) }"
              @click="filterRange(600, 800)"
            >
              600–800
            </button>
          </div>
