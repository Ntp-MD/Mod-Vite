<template>
  ...
  <div class="map_layout">
    <div class="map_content" ref="map">
      <img
        src="https://itp1.itopfile.com/ImageServer/z_itp_12052025qsdh/0/0/white-mapz-z1584138795656.png"
        alt=""
      />
      <mark
...
<script setup lang="ts">
  ...
  function startDrag(e: MouseEvent, idx: number) {
    ...
    dragTimer = setTimeout(() => {
      dragStarted = true
      dragging.value = idx
      const marker = (e.target as HTMLElement).closest('mark')
      if (!marker) return
  ...
  function onDrag(e: MouseEvent) {
    if (!dragStarted || dragging.value === null || !map.value) return
