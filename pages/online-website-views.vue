  ...
  <ClientOnly>
      ...
      <div class="wrapper-scroll">
        ...
        <div class="pagination-container">
          ...
          <div class="pagination-controls">
            ...
            <button v-for="p in pageWindow" :key="p" :class="{ active: p === currentPage }" @click="gotoPage(p)">
              {{ p }}
            </button>
            <button :disabled="currentPage === totalPages" @click="nextPage" title="Next">›</button>
            <button :disabled="currentPage === totalPages" @click="goLast" title="Last">»</button>
          </div>
        </div>
      </div>
    ...
    <template #fallback>
      <div class="loading-container">
        <div class="loading-message">Loading website data...</div>
      </div>
    </template>
  </ClientOnly>
</template>
