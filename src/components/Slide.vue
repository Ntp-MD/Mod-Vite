    ...
    <div id="box_slide">
      <div class="box_items">
        ...
        <article>
          ...
          <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci beatae mollitia, ut itaque nihil quia fugiat distinctio libero possimus eveniet.</div>
        </article>
      </div>
      <div class="box_items">
        <div class="box_items_img">
