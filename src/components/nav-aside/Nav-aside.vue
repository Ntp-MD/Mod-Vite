<template>
  <div class="nav-aside">
    ...
    <div class="mid-aside">
      <div class="nav-menu">
        <span>overview</span>
        <router-link class="nav-link" to="/page1"><img src="@img/icons/home.png" alt="" />Test space</router-link>
        <router-link class="nav-link" to=""><img src="@img/icons/menu.png" alt="" />application</router-link>
